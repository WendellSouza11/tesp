...
public class Teste {
	...
	public void testeCriacaoFuncionario(){ 
			...
			Funcionario o = new Funcionario(1L, "Joao", "M", "11111111111", null, null, null, null, null, null, null, null, null);
	...
	public void testeComparacaoFuncionario(){
		...
		Funcionario o = new Funcionario(1L, "Joao", "M", "11111111111", null, null, null, null, null, null, null, null, null);
		Funcionario o2 = new Funcionario(1L, "Joao", "M", "11111111111", null, null, null, null, null, null, null, null, null);
		Assert.assertTrue(o.equals(o2));
		Funcionario o3 = new Funcionario(1L, "sfsadJoao", "M", "11111111111", null, null, null, null, null, null, null, null, null);
